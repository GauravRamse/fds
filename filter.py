...
# please provide path of image
path_of_image_to_smoothen = r'C:\Users\Gaurav Ramse\Desktop\Data science sapienza\FDS\Assignment 1\Assignment1\Filtering\graf.png'
...
img = rgb2gray(np.array(Image.open(path_of_image_to_smoothen)))
...
# ***** we are working on this probably, This will be done by tomorrow
...
img_c = np.array(Image.open(path_of_image_to_smoothen)).astype('double')
img = rgb2gray(img_c)
